...
cut_comunas <- readxl::read_excel("datos/originales/Libro_de_codigos_Base_de_datos_provincia_y_comuna_Casen_2022.xlsx") |> 
...
# cargar columnas de comunas
ruta_casen <- "~/Datos/casen/" # tienes qu proveer tu propia base de casen, descargable con el script importar.R o en https://observatorio.ministeriodesarrollosocial.gob.cl 

casen2022comunas <- readstata13::read.dta13(paste0(ruta_casen, "Base de datos provincia y comuna Casen 2022 STATA.dta"), 
                                                   generate.factors = T) |> 
  as_tibble() |> 
  left_join(cut_comunas, join_by(comuna))

# cargar base
casen2022 <- readstata13::read.dta13(paste0(ruta_casen, "Base de datos Casen 2022 STATA.dta"), 
                                            generate.factors = T) |> 
  as_tibble()
...
# guardar
arrow::write_parquet(casen2022_2, "datos/originales/casen2022.parquet")
